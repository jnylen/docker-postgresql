...
Automated builds of the image are available on [Dockerhub](https://hub.docker.com/r/jnylen/postgresql) and is the recommended method of installation.
...
```bash
docker build -t jnylen/postgresql github.com/jnylen/docker-postgresql
```
